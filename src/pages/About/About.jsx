    ...
    <div className="pb-16">
      <header className="bg-gradient-to-r from-[#e6f6ff] to-white dark:from-slate-900 dark:to-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-20 text-center">
          <h1 className="text-4xl font-extrabold text-sky-800 ">About LearnEnglish</h1>
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            ...
            <a href="/tutors" className="inline-flex items-center gap-2 border-2  px-5 py-3 rounded-lg">Find Tutors</a>
          </div>
        </div>
      </header>
